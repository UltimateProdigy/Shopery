...
export default function ProductDetails() {
	...
	return (
		<div className="flex gap-10 px-[150px] mt-10">
			<div className="product-image-container w-full max-w-[500px] aspect-square overflow-hidden flex items-center justify-center">
				<img
					src={product.image}
					alt={product.name}
			...
			<div className="w-full">
				<div className="flex gap-4">
					...
					<span className="h-6 mt-2 bg-[#00B207] text-white text-xs font-semibold px-2 py-1 rounded">
						In-Stock
					</span>
				</div>
				...
				<div className="flex gap-4 mt-4">
					<Counter
						...
						initialQuantity={itemInCart ? itemInCart.quantity : 1}
						onQuantityChange={setQuantity}
					/>
					<Button
						className={`${
							itemInCart ? "bg-red-500" : "bg-[#00B207]"
						} rounded-full w-[370px]`}
